...
abstract class $ProductCopyWith<$Res> {
  ...
  $Res call(
      ...
      @JsonKey(name: 'discountPercentage') double discount,
...
class _$_Product implements _Product {
  ...
  @override
  String toString() {
    return 'Product(id: $id, title: $title, desc: $desc, price: $price, discount: $discount, rating: $rating, stock: $stock, brand: $brand, category: $category, thumbnail: $thumbnail, images: $images)';
  }
...
abstract class _Product implements Product {
  factory _Product(
          ...
          @JsonKey(name: 'discountPercentage') required final double discount,
